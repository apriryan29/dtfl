    ...
    <!-- partial:partials/_navbar.html -->
     <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="../index.php"><img src="../assets/img/logo.webp" class="mr-2" alt="logo"/></a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#mitra" aria-expanded="false" aria-controls="mitra">
              ...
              <span class="menu-title">Mitra dan Tim</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="mitra">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="mitra.php">Input Mitra dan Tim</a></li>
                <li class="nav-item"> <a class="nav-link" href="datatim.php">Data Tim</a></li>
                <li class="nav-item"> <a class="nav-link" href="datamitra.php">Data Mitra</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="adminlayanan.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="datakonsul.php">
              <i class="icon-columns menu-icon"></i>
